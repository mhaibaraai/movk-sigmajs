...
seo:
  title: Introduction
  description: A declarative sigma v3 wrapper for Vue 3 and Nuxt 4 with 11 components, 16 composables and 7 utilities for large-scale knowledge graph visualization.
---
